        ...
        <div class="w-50 mx-auto">
          <form action="#" method="POST" class="my-5">
            ...
            <div class="input-group mb-4">
              ...
              <input type="text" class="form-control" placeholder="Your User Name" aria-label="userName"
            ...
            <div class="input-group mb-4">
              ...
              <input type="tel" class="form-control" placeholder="Your Phone Number" aria-label="phNumber"
                aria-describedby="phNumber" required>
            </div>
            <div class="input-group mb-4">
              <span class="input-group-text" id="pWord">Password</span>
              <input type="password" class="form-control" placeholder="Enter your password" aria-label="pWord"
                aria-describedby="pWord" required>
            </div>
            <div class="input-group mb-4">
              <span class="input-group-text" id="confPass">Confirm Password</span>
              <input type="password" class="form-control" placeholder="Confirm your password" aria-label="confPass"
                aria-describedby="confPass" required>
            </div>
